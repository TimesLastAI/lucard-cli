...
/// LucardApp handles the core chat functionality by orchestrating various
/// services. It encapsulates the complex logic previously contained in the
/// LucardAPI chat method.
pub struct LucardApp<S> {
    services: Arc<S>,
    tool_registry: ToolRegistry<S>,
    authenticator: Authenticator<S>,
}

impl<S: Services> LucardApp<S> {
    /// Creates a new LucardApp instance with the provided services.
    ...
    /// This method contains the core chat logic extracted from LucardAPI.
    pub async fn chat(
        &self,
        agent_id: AgentId,
        chat: ChatRequest,
    ...
    pub async fn compact_conversation(
        ...
        let mut conversation = self
            ...
            .await?
            .ok_or_else(|| lucard_domain::Error::ConversationNotFound(*conversation_id))?;
