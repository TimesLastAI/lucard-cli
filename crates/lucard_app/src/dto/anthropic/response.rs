...
impl From<Model> for lucard_domain::Model {
    fn from(value: Model) -> Self {
        ...
        {
            vec![
                lucard_domain::InputModality::Text,
                lucard_domain::InputModality::Image,
            ]
        } else {
            vec![lucard_domain::InputModality::Text]
        };
...
impl From<Usage> for lucard_domain::Usage {
...
impl From<StopReason> for lucard_domain::FinishReason {
    fn from(value: StopReason) -> Self {
        match value {
            StopReason::EndTurn => lucard_domain::FinishReason::Stop,
            StopReason::MaxTokens => lucard_domain::FinishReason::Length,
            StopReason::StopSequence => lucard_domain::FinishReason::Stop,
            StopReason::ToolUse => lucard_domain::FinishReason::ToolCalls,
        }
    }
}
...
mod tests {
    ...
    fn test_usage_conversion_with_cache_read_tokens() {
        ...
        let actual: lucard_domain::Usage = fixture.into();
    ...
    fn test_model_conversion_includes_context_length() {
        ...
        let actual: lucard_domain::Model = fixture.into();
