...
#[cfg(test)]
mod tests {
    use lucard_domain::{Context, ContextMessage, ModelId, Role, TextMessage};
    use pretty_assertions::assert_eq;

    use super::*;

    async fn load_auth_message() -> String {
        lucard_common::fixture!("/src/dto/anthropic/transforms/claude_code.md").await
    }
