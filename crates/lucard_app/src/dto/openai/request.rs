...
pub struct Request {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub reasoning: Option<lucard_domain::ReasoningConfig>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl From<lucard_domain::Role> for Role {
    fn from(role: lucard_domain::Role) -> Self {
        match role {
            lucard_domain::Role::System => Role::System,
            lucard_domain::Role::User => Role::User,
            lucard_domain::Role::Assistant => Role::Assistant,
        }
    }
}
...
<task>
    ...
    fn test_context_conversion_stream_defaults_to_true() {
        let fixture = lucard_domain::Context::default();
    ...
    fn test_context_conversion_stream_explicit_true() {
        let fixture = lucard_domain::Context::default().stream(true);
        let actual = Request::from(fixture);
    ...
    fn test_context_conversion_stream_explicit_false() {
        let fixture = lucard_domain::Context::default().stream(false);
        let actual = Request::from(fixture);
