...
impl From<lucard_domain::ToolChoice> for ToolChoice {
    fn from(value: lucard_domain::ToolChoice) -> Self {
        match value {
            lucard_domain::ToolChoice::None => ToolChoice::None,
            lucard_domain::ToolChoice::Auto => ToolChoice::Auto,
            lucard_domain::ToolChoice::Required => ToolChoice::Required,
            lucard_domain::ToolChoice::Call(tool_name) => ToolChoice::Function {
