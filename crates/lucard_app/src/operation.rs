...
use lucard_common::template::Element;
use lucard_domain::{
...
pub enum ToolOperation {
    ...
    Skill {
        #[allow(dead_code)]
        input: lucard_domain::SkillFetch,
        output: lucard_domain::Skill,
    },
}
        ...
        match self {
            ToolOperation::FsRead { input, output } => {
                ...
                *metrics = metrics.clone().insert(
                ...
                lucard_domain::ToolOutput::text(elm)
            }
            ToolOperation::ImageRead { output } => lucard_domain::ToolOutput::image(output),
            ...
            ToolOperation::FsRemove { input, output } => {
                ...
                *metrics = metrics.clone().insert(
                ...
                lucard_domain::ToolOutput::text(elem)
            }
            ...
            ToolOperation::Shell { output } => {
                ...
                lucard_domain::ToolOutput::text(parent_elem)
            }
