...
impl AgentId {
    ...
    pub const FORGE: AgentId = AgentId(Cow::Borrowed("lucard"));
    pub const LUCARD: AgentId = AgentId(Cow::Borrowed("lucard"));
...
pub struct ReasoningConfig {
    ...
    /// supported by openrouter and lucard provider
    #[serde(skip_serializing_if = "Option::is_none")]
    pub effort: Option<Effort>,

    /// Controls how many tokens the model can spend thinking.
    /// supported by openrouter, anthropic and lucard provider
