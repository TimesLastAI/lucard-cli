...
pub struct Environment {
    ...
    /// Base URL for Lucard's backend APIs
    #[dummy(expr = "url::Url::parse(\"https://example.com\").unwrap()")]
    pub lucard_api_url: Url,
...
impl Environment {
    ...
    pub fn history_path(&self) -> PathBuf {
        self.custom_history_path
            .clone()
            .unwrap_or(self.base_path.join(".lucard_history"))
    }
    ...
    /// Returns the global skills directory path (~/lucard/skills)
    pub fn global_skills_path(&self) -> PathBuf {
        self.base_path.join("skills")
    }

    /// Returns the project-local skills directory path (.lucard/skills)
    pub fn local_skills_path(&self) -> PathBuf {
        self.cwd.join(".lucard/skills")
    }
...
mod tests {
    ...
    fn test_agent_cwd_path() {
        ...
        let expected = PathBuf::from("/current/working/dir/.lucard/agents");
    ...
    fn test_agent_cwd_path_independent_from_agent_path() {
        ...
        let expected_agent_cwd_path = PathBuf::from("/different/current/dir/.lucard/agents");
    ...
    fn test_global_skills_path() {
        let fixture: Environment = Faker.fake();
        let fixture = fixture.base_path(PathBuf::from("/home/user/.lucard"));

        let actual = fixture.global_skills_path();
        let expected = PathBuf::from("/home/user/.lucard/skills");
    ...
    fn test_local_skills_path() {
        ...
        let expected = PathBuf::from("/projects/my-app/.lucard/skills");
    ...
    fn test_skills_paths_independent() {
        ...
        let fixture = fixture
            ...
            .base_path(PathBuf::from("/home/user/.lucard"));

        let global_path = fixture.global_skills_path();
        let local_path = fixture.local_skills_path();

        let expected_global = PathBuf::from("/home/user/.lucard/skills");
        let expected_local = PathBuf::from("/projects/my-app/.lucard/skills");
...
fn test_command_path() {
    let fixture = Environment {
        ...
        shell: "zsh".to_string(),
        base_path: PathBuf::from("/home/user/.lucard"),
        lucard_api_url: "https://api.example.com".parse().unwrap(),
    ...
    let expected = PathBuf::from("/home/user/.lucard/commands");
...
fn test_command_cwd_path() {
    ...
    let expected = PathBuf::from("/current/working/dir/.lucard/commands");
...
fn test_command_cwd_path_independent_from_command_path() {
    ...
    let expected_command_cwd_path = PathBuf::from("/different/current/dir/.lucard/commands");
