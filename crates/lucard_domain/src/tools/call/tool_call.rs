...
impl ToolCallId {
    ...
    fn generate() -> Self {
        let id = format!("lucard_call_id_{}", uuid::Uuid::new_v4());
        ToolCallId(id)
    }
}
...
impl ToolCallFull {
    ...
    pub fn try_from_xml(input: &str) -> std::result::Result<Vec<ToolCallFull>, Error> {
        match extract_tag_content(input, "lucard_tool_call") {
...
fn json_repair_parse<T>(
    json_str: &str,
) -> std::result::Result<T, lucard_common::json_repair::JsonRepairError>
where
    T: serde::de::DeserializeOwned,
{
    serde_json::from_str(json_str)
        .map_err(lucard_common::json_repair::JsonRepairError::JsonError)
        .or_else(|_| {
            let repaired = lucard_common::json_repair::json_repair(json_str);
            if repaired.is_ok() {
...
mod tests {
    ...
    fn test_multiple_calls() {
        let input = [
            ToolCallPart {
                ...
                arguments_part: "{\"path\": \"crates/lucard_services/src/fixtures/".to_string(),
            },
            ToolCallPart {
                call_id: None,
                name: None,
            ...
            ToolCallPart {
                ...
                name: Some(ToolName::new("read")),
                arguments_part: "{\"path\": \"crates/lucard_services/src/service/".to_string(),
            },
            ToolCallPart {
                call_id: None,
                name: None,
        ...
        let expected = vec![
            ToolCallFull {
                ...
                arguments: ToolCallArguments::from_json(
                    r#"{"path": "crates/lucard_services/src/fixtures/mascot.md"}"#,
                ),
                timestamp: None,
                cwd: None,
            },
            ...
            ToolCallFull {
                ...
                call_id: Some(ToolCallId("call_3".to_string())),
                arguments: ToolCallArguments::from_json(
                    r#"{"path": "crates/lucard_services/src/service/service.md"}"#,
                ),
                timestamp: None,
                cwd: None,
            },
    ...
    async fn test_real_example() {
        let message = lucard_common::fixture!("/src/fixtures/tool_call_01.md").await;
    ...
    async fn test_try_from_xml_call_id() {
        ...
        assert!(actual.as_str().starts_with("lucard_call_id_"));
    }
    #[test]
