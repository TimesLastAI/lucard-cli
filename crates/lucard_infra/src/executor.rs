...
use lucard_app::CommandInfra;
use lucard_domain::{CommandOutput, Environment};
...
#[derive(Clone, Debug)]
pub struct LucardCommandExecutorService {
    restricted: bool,
    env: Environment,
...
impl LucardCommandExecutorService {
...
impl CommandInfra for LucardCommandExecutorService {
...
mod tests {
    ...
    async fn test_command_executor() {
        let fixture = LucardCommandExecutorService::new(false, test_env());
