...
use lucard_app::McpClientInfra;
use lucard_domain::{Image, McpHttpServer, McpServerConfig, ToolDefinition, ToolName, ToolOutput};
...
impl McpClientInfra for LucardMcpClient {
    async fn list(&self) -> anyhow::Result<Vec<ToolDefinition>> {
...
fn resolve_http_templates(
    ...
    let handlebars = lucard_app::TemplateEngine::handlebar_instance();
