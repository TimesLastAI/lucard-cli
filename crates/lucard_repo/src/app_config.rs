...
use lucard_domain::{AppConfig, AppConfigRepository, ModelId, ProviderId};
    ...
    async fn read(&self) -> AppConfig {
        ...
        serde_json::from_str::<AppConfig>(&content)
            .or_else(|_| {
                ...
                lucard_common::json_repair::json_repair::<AppConfig>(&content).inspect(|_| {
...
mod tests {
    ...
    use bytes::Bytes;
    use lucard_app::{EnvironmentInfra, FileReaderInfra, FileWriterInfra};
    use lucard_domain::{AppConfig, Environment, ProviderId};
