...
use diesel::prelude::*;
use lucard_domain::{Conversation, ConversationId, ConversationRepository, WorkspaceHash};
...
mod tests {
    ...
    fn test_context_record_conversion_preserves_all_fields() {
        ...
        let reasoning = lucard_domain::ReasoningConfig {
        ...
        let messages = vec![
            ...
            .into(),
            lucard_domain::MessageEntry {
                message: ContextMessage::Text(lucard_domain::TextMessage {
                    role: Role::Assistant,
                    ...
                    tool_calls: Some(vec![ToolCallFull {
                        ...
                        arguments: lucard_domain::ToolCallArguments::from(
                            serde_json::json!({"param": "value"}),
                        ),
                        timestamp: None,
                        cwd: None,
                    }]),
                    model: Some(lucard_domain::ModelId::from("gpt-4")),
                    reasoning_details: None,
                    droppable: false,
                }),
                usage: Some(Usage {
                    prompt_tokens: lucard_domain::TokenCount::Actual(100),
                    completion_tokens: lucard_domain::TokenCount::Actual(50),
                    total_tokens: lucard_domain::TokenCount::Actual(150),
                    cached_tokens: lucard_domain::TokenCount::Actual(0),
                    cost: Some(0.001),
                }),
            },
        ];
        ...
        let fixture = Context::default()
            ...
            .temperature(lucard_domain::Temperature::new(0.7).unwrap())
            .top_p(lucard_domain::TopP::new(0.9).unwrap())
            .top_k(lucard_domain::TopK::new(50).unwrap())
