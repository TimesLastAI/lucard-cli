...
use dashmap::DashMap;
use lucard_app::AgentRepository;
use lucard_app::domain::AgentId;
use lucard_domain::{Agent, AppConfigRepository, ProviderRepository};
...
/// access.
pub struct LucardAgentRegistryService<R> {
...
impl<R> LucardAgentRegistryService<R> {
...
impl<R: AgentRepository + AppConfigRepository + ProviderRepository> LucardAgentRegistryService<R> {
...
impl<R: AgentRepository + AppConfigRepository + ProviderRepository> lucard_app::AgentRegistry
    for LucardAgentRegistryService<R>
{
