...
impl<F: FileReaderInfra + FileWriterInfra + FileInfoInfra + EnvironmentInfra + DirectoryReaderInfra>
    lucard_app::CommandLoaderService for CommandLoaderService<F>
{
...
mod tests {
    ...
    async fn test_parse_basic_command() {
        let content = lucard_common::fixture!("src/fixtures/commands/basic.md").await;
    ...
    async fn test_parse_command_with_multiline_prompt() {
        let content = lucard_common::fixture!("src/fixtures/commands/multiline.md").await;
    ...
    async fn test_parse_invalid_frontmatter() {
        let content = lucard_common::fixture!("src/fixtures/commands/invalid.md").await;
    ...
    async fn test_parse_builtin_commands() {
        ...
        let builtin_commands = [
            ("fixme", "../../.lucard/commands/fixme.md"),
            ("check", "../../.lucard/commands/check.md"),
        ];

        for (name, path) in builtin_commands {
            let content = lucard_common::fixture!(path).await;
