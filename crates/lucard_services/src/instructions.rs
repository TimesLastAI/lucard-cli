...
use lucard_app::{CommandInfra, CustomInstructionsService, EnvironmentInfra, FileReaderInfra};
...
#[derive(Clone)]
pub struct LucardCustomInstructionsService<F> {
    infra: Arc<F>,
    cache: tokio::sync::OnceCell<Vec<String>>,
}

impl<F: EnvironmentInfra + FileReaderInfra + CommandInfra> LucardCustomInstructionsService<F> {
...
impl<F: EnvironmentInfra + FileReaderInfra + CommandInfra> CustomInstructionsService
    for LucardCustomInstructionsService<F>
{
