...
#[derive(Clone)]
pub struct LucardPolicyService<I> {
    infra: Arc<I>,
}
lazy_static! {
    ...
    I: FileReaderInfra + FileWriterInfra + FileInfoInfra + EnvironmentInfra + DirectoryReaderInfra,
{
    ...
    /// Load all policy definitions from the lucard/policies directory
...
impl<I> PolicyService for LucardPolicyService<I>
where
    I: FileReaderInfra
        + FileWriterInfra
        + FileInfoInfra
