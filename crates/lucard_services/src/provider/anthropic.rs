...
use lucard_app::domain::{ChatCompletionMessage, Context, Model, ModelId, ResultStream, Transformer};
use lucard_app::dto::anthropic::{
...
pub struct Anthropic<T> {
    ...
    api_key: String,
    chat_url: Url,
    models: lucard_domain::ModelSource<Url>,
...
mod tests {
    ...
    async fn test_url_for_models() {
        ...
        let anthropic = Anthropic::new(
            ...
            chat_url,
            lucard_domain::ModelSource::Url(model_url.clone()),
            "v1".to_string(),
            false,
        );
