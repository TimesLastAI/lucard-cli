use lucard_app::domain::{Error as DomainError, RetryConfig};
use lucard_app::dto::openai::{Error, ErrorResponse};
...
mod tests {
    use anyhow::anyhow;
    use lucard_app::dto::openai::{Error, ErrorCode, ErrorResponse};
