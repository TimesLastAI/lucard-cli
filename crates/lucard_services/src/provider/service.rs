...
use lucard_app::{EnvironmentInfra, HttpInfra, ProviderService};
use lucard_domain::{Provider, ProviderRepository};
...
#[derive(Clone)]
pub struct LucardProviderService<I: HttpInfra> {
...
impl<I: EnvironmentInfra + HttpInfra> LucardProviderService<I> {
    ...
    for LucardProviderService<I>
{
    ...
    async fn upsert_credential(&self, credential: lucard_domain::AuthCredential) -> Result<()> {
