...
use bytes::Bytes;
use lucard_app::domain::{CommandOutput, Environment, ToolDefinition, ToolName, ToolOutput};
use lucard_app::{
...
impl FileReaderInfra for MockFileService {
    ...
    async fn range_read_utf8(
        ...
        Ok((
            filtered_content,
            lucard_domain::FileInfo::new(actual_start, actual_end, all_lines.len() as u64),
        ))
    }
}
...
impl McpServerInfra for Mock {
    ...
    async fn connect(
        &self,
        _: lucard_app::domain::McpServerConfig,
