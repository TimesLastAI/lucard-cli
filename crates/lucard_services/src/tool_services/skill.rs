...
use lucard_app::SkillFetchService;
use lucard_domain::Skill;
...
pub struct LucardSkillFetch<R> {
    repository: Arc<R>,
    cache: OnceCell<Vec<Skill>>,
}

impl<R> LucardSkillFetch<R> {
...
impl<R: lucard_domain::SkillRepository> SkillFetchService for LucardSkillFetch<R> {
...
impl<R: lucard_domain::SkillRepository> LucardSkillFetch<R> {
...
mod tests {
    ...
    #[async_trait::async_trait]
    impl lucard_domain::SkillRepository for MockSkillRepository {
    ...
    async fn test_fetch_skill_found() {
        ...
        let fetch_service = LucardSkillFetch::new(Arc::new(repo));
